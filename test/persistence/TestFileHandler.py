...
#         print self.project_sodocu_path + '/sodocu/idea/ThisIsAFileWriterTest.txt'
        ...
        idea2 = create_item(config, self.project_sodocu_path + '/idea/ThisIsAFileWriterTest.txt')
...
#         with self.assertRaises(IOError):
    ...
    def test_update_file_changed_item_name(self):
        config = read_file(self.project_sodocu_path + '/idea/ThisIsAFileWriterTest.txt')
        idea1 = create_item(config, self.project_sodocu_path + '/idea/ThisIsAFileWriterTest.txt')
        ...
        idea2 = create_item(config, self.project_sodocu_path + '/idea/ThisIsAFileUpdateTest.txt')
        assert idea1.get_id() == idea2.get_id()
